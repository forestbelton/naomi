...
const INITIAL_GUESSES_LEFT = 6

module.exports = new Command({
    name: 'guess100',
    command: ({ kdb, logger, message, state}, number) => {
        ...
        // Guess provided
            ...
            if (typeof game === 'undefined') {
                ...
                if (guessMatched) {
                    ...
                    const trailingText = gameOver ? `Game over! The answer was ${game.number}.` : `You have ${game.left} guesses next.`
